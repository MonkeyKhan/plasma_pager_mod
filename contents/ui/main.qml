...
MouseArea {
    ...
    readonly property color windowActiveOnActiveDesktopColor: colorWithAlpha(PlasmaCore.Theme.textColor, 0.3)
    readonly property color windowInactiveOnActiveDesktopColor: colorWithAlpha(PlasmaCore.Theme.textColor, 0.0)
    readonly property color windowActiveColor: colorWithAlpha(PlasmaCore.Theme.textColor, 0.3)
    readonly property color windowActiveBorderColor: colorWithAlpha(PlasmaCore.Theme.textColor, 0.5)
    readonly property color windowInactiveColor: colorWithAlpha(PlasmaCore.Theme.textColor, 0.0)
